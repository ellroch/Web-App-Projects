<%@ Page Title="Your Shopping Cart" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="XEx19HalloweenStore.Cart" %>
            ...
            <div class="form-group"><%-- buttons --%>
                <div class="col-sm-12">
                    ...
                    <asp:Button ID="btnCheckOut" runat="server" Text="Check Out"  
                        PostBackUrl="~/CheckOut1.aspx" CssClass="btn" />
                </div>
            </div>
        </div>
    </div><%-- end of row 2 --%>
