<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="XEx20UserMaintenance._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HyperLink runat="server" NavigateUrl="~/Maintenance">Maintain Users and Roles</asp:HyperLink><br />
